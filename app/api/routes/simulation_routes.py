...
class RiskSimulationRequest(BaseModel):
    tenant_slug: str | None = Field(None, description="Tenant slug. Defaults to demo-public.")
    tenant_id: int | None = Field(None, description="Tenant id for private workspaces.")
    name: str | None = None
...
def run_risk_simulation(
    ...
    if (
        ...
        and request.tenant_slug is None
        and token_data
        and token_data.memberships
    ):
