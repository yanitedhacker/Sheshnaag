...
class FeatureEngineer:
    ...
    def _extract_cvss_features(self, cve: CVE) -> dict[str, Any]:
        ...
        return {
            ...
            "is_easy_exploit": 1
            if cve.attack_complexity == "LOW" and cve.privileges_required == "NONE"
            else 0,
        }
    ...
    def _extract_cwe_features(self, cve: CVE) -> dict[str, Any]:
        ...
        return {
            ...
            "is_injection_cwe": 1
            if any(c in cwe_id for c in ["CWE-89", "CWE-78", "CWE-77", "CWE-94"])
            else 0,
    ...
    def get_feature_names(self) -> list[str]:
        ...
        return [
            ...
            "is_auth_cwe",
            # Text features
            "text_remote_code_exec",
            "text_privilege_escalation",
            "text_denial_of_service",
            "text_information_disclosure",
            "text_authentication_bypass",
            "text_sql_injection",
            "text_xss",
